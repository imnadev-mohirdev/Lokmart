...
import uz.mohirdev.lokmart.common.Constants
import uz.mohirdev.lokmart.data.api.product.dto.Product
import uz.mohirdev.lokmart.databinding.FragmentDetailBinding
...
class DetailFragment : BaseFragment<FragmentDetailBinding>(FragmentDetailBinding::inflate) {
    ...
    private fun initUI() = with(binding) {
        ...
        add.setOnClickListener {
            viewModel.set()
            Snackbar.make(root, R.string.fragment_detail_cart_addded, Snackbar.LENGTH_SHORT).show()
            findNavController().popBackStack()
        }
    }
